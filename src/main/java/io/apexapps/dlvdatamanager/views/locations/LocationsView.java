...
@PageTitle("Locations")
@Route(value = "locations/:locationID?/:action?(edit)", layout = MainLayout.class)
public class LocationsView extends Div implements BeforeEnterObserver {
    ...
    private final CollaborationBinder<Location> binder;
    ...
    public LocationsView(LocationService locationService) {
        ...
        // Configure Form
        binder = new CollaborationBinder<>(Location.class, userInfo);
    ...
    private void populateForm(Location value) {
        ...
        if (this.location != null && this.location.getId() != null) {
            topic = "location/" + this.location.getId();
            avatarGroup.getStyle().set("visibility", "visible");
        } else {
            avatarGroup.getStyle().set("visibility", "hidden");
        }
        binder.setTopic(topic, () -> this.location);
